...
> Đây là phiên bản chỉnh sửa của ứng dụng LeanKeyboard hỗ trợ gõ tiếng Việt kiểu Telex, có gợi ý từ cho tiếng Việt và nhập bằng giọng nói của Google. Bàn phím dành cho Android TV có hỗ trợ nhập bằng điều khiển TV box, chuột và giọng nói.


> This is a modified version of LeanKeyboard supporting Vietnamese Telex Typing, word suggestions for Vietnamese and Google Voice Typing. This keyboard for Android TV supports input via TV box remote, mouse and voice control.
